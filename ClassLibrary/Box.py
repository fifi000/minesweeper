...
class Box:
    ...
    def __init__(self, win, text, font, win_width, win_height, play_obj, repeat_obj, best_time, best_time_font):
        self.win = win
        ...
        self.box_h = 4*Box.gap + 3 * self.main_msg.get_height() + self.best_time_msg.get_height()
